...
_TASK_ROUTING = {
    "code": (Provider.CLAUDE, "claude-sonnet-4-5-20250929"),
    "debug": (Provider.CLAUDE, "claude-sonnet-4-5-20250929"),
    "refactor": (Provider.CLAUDE, "claude-sonnet-4-5-20250929"),
    ...
    "general": (Provider.CLAUDE, "claude-sonnet-4-5-20250929"),
}
