    ...
    <section className="relative pt-32 pb-20 overflow-hidden">
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        <div className="inline-flex items-center gap-2 px-4 py-1.5 bg-indigo-500/10 border border-indigo-500/20 rounded-full mb-8">
          ...
          <span className="text-sm text-indigo-300">v3.1 — pip install & One-Click Installer</span>
        </div>
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
          <a
            href={INSTALLER_URL}
            className="group px-8 py-4 bg-indigo-600 hover:bg-indigo-500 text-white font-semibold rounded-xl transition-all shadow-lg shadow-indigo-600/25 hover:shadow-indigo-500/40 hover:scale-105 flex items-center gap-3 text-lg"
          >
          ...
          <a
            href="#how-it-works"
            className="px-8 py-4 bg-gray-800 hover:bg-gray-700 text-gray-200 font-semibold rounded-xl transition-colors border border-gray-700"
          >
            How It Works
          </a>
        </div>
        ...
        <p className="mt-4 text-sm text-gray-500">
          Windows — Double-click to install everything automatically
        </p>
        <p className="mt-1 text-sm text-gray-600">
          Developer? <code className="text-indigo-400/70">pip install git+{GITHUB_URL}.git</code>
        </p>
